...
<div id="site-header-menu-mobile" class="site-primary-menu">
	<nav id="site-primary-navigation-mobile" class="main-navigation site-navigation custom-primary-menu" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'consultare' ); ?>">
